...
# ---------------------------------------------------------------- 風險構面
#
# 原本還有「營運風險」（師生比、超收率、教師流動、負責人跨園關聯）構面，
# 但兩歲/三至五歲分齡入園人數、教保人員異動、負責人跨園登記都沒有可取得的
# 公開資料來源，四個子指標實測全數恆為 0，等同整個構面沒有訊號，故移除，
# 不用一個「看起來有分數、實際上永遠是 0」的構面誤導判讀。
DIMENSIONS = [
    ("compliance", "法遵風險", "裁罰紀錄之頻率、金額、嚴重度與再犯情形"),
    ("financial", "財務風險", "決算之比率異常、班佛定律、同儕偏離"),
